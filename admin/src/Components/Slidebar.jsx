  ...
  return (
    <div className="w-[22%] min-h-screen border-r-2 border-gray-200 bg-white">
      ...
      <div className='flex flex-col gap-4 pt-6'>
        ...
        <button onClickCapture={() => setToken("")}
        className='flex item-center gap-3 px-6 py-3 border-b-2 border-gray-200 text-gray-600 hover:bg-amber-500 hover:text-white w-full text-left' onClick={() => setToken("")}>
